...
const Footer = () => {
  return (
    <>
        <div className="footer1 position-relative">
            <p className='position-absolute bottom-0 start-0 ps-5'>	&copy; University of Delhi All Right Reserved</p>
            <div className="social position-absolute bottom-0 end-0 pe-5">
